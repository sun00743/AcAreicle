...
class RebroadcastBroadcastWriter extends ResourceWriter<RebroadcastBroadcastWriter, Broadcast> {
    ...
    public void onResponse(Broadcast response) {
        ...
        ToastUtil.show(mRebroadcast ? R.string.broadcast_rebroadcast_successful
    ...
    public void onErrorResponse(VolleyError error) {
        ...
        ToastUtil.show(context.getString(mRebroadcast ? R.string.broadcast_rebroadcast_failed_format
