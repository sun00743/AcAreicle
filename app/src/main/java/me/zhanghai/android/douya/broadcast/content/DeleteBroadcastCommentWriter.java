...
class DeleteBroadcastCommentWriter extends ResourceWriter<DeleteBroadcastCommentWriter, Boolean> {
    ...
    public void onResponse(Boolean response) {
        ...
        ToastUtil.show(R.string.broadcast_comment_delete_successful, getContext());
    ...
    public void onErrorResponse(VolleyError error) {
        ...
        ToastUtil.show(context.getString(R.string.broadcast_comment_delete_failed_format,
