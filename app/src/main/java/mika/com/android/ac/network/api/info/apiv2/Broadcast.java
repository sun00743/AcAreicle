...
public class Broadcast implements Parcelable {
    ...
    public String getRebroadcastedBy(Context context) {
        return rebroadcastedBroadcast != null ?
                context.getString(mika.com.android.ac.R.string.broadcast_rebroadcasted_by_format, getAuthorName())
                : null;
    }

    /**
     * Use {@link TimeActionTextView} instead if the text is to be set
     * on a {@code TextView}.
     */
    public String getActionWithTime(Context context) {
        return context.getString(mika.com.android.ac.R.string.broadcast_time_action_format,
