...
public class CollectedItem implements Parcelable {
    ...
    public enum State {
        ...
        TODO("wish", mika.com.android.ac.R.string.item_todo_format),
        DOING("do", mika.com.android.ac.R.string.item_doing_format),
        DONE("collect", mika.com.android.ac.R.string.item_done_format);
