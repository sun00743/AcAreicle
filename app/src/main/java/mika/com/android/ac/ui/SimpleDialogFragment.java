...
public class SimpleDialogFragment extends DialogFragment {
    ...
    private static SimpleDialogFragment makeClose(int requestCode, Integer titleId, int messageId,
        ...
        return new Builder(context)
                ...
                .setPositiveButtonText(mika.com.android.ac.R.string.close)
                .build();
    }
    ...
    private static SimpleDialogFragment makeOkCancel(int requestCode, Integer titleId,
        ...
        return new Builder(context)
                ...
                .setTitle(titleId)
                .setMessage(messageId)
                .setPositiveButtonText(mika.com.android.ac.R.string.ok)
                .setNegativeButtonText(mika.com.android.ac.R.string.cancel)
                .build();
    }
    ...
    private static SimpleDialogFragment makeYesNo(int requestCode, Integer titleId, int messageId,
        ...
        return new Builder(context)
                ...
                .setTitle(titleId)
                .setMessage(messageId)
                .setPositiveButtonText(mika.com.android.ac.R.string.yes)
                .setNegativeButtonText(mika.com.android.ac.R.string.no)
                .build();
    }
