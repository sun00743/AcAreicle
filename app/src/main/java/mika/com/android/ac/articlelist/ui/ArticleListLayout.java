...
//    private BroadcastAdapter mAdapter = null;
    ...
    private void init() {
        ...
        ViewUtils.inflateInto(mika.com.android.ac.R.layout.articlelist_layout, this);
...
//    }
    ...
    public void cleanAvatarImage(){
        ...
        mAvatarImage.setImageResource(mika.com.android.ac.R.drawable.avatar_icon_grey600_40dp);
    }
...
//        if (broadcast.isInterest) {
        mAvatarImage.setImageDrawable(ContextCompat.getDrawable(context,
                mika.com.android.ac.R.drawable.avatar_icon_grey600_40dp));
