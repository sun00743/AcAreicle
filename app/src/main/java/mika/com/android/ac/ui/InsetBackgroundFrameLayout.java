...
public class InsetBackgroundFrameLayout extends FrameLayout {
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs,
                mika.com.android.ac.R.styleable.InsetBackgroundFrameLayout, defStyleAttr, defStyleRes);
        mInsetBackground = a.getDrawable(mika.com.android.ac.R.styleable.InsetBackgroundFrameLayout_insetBackground);
        a.recycle();
