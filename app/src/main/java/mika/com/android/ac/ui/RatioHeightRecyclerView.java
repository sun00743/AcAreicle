...
public class RatioHeightRecyclerView extends RecyclerView {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs,
                mika.com.android.ac.R.styleable.RatioHeightRecyclerView, defStyle, 0);
        String ratio = a.getString(mika.com.android.ac.R.styleable.RatioHeightRecyclerView_ratio);
        if (ratio != null) {
